...
class Trainer(object):
    ...
    def run_valid(self, i):
        ...
        print(f"A: NDCG: {NDCG_a:.4f}, HT: {HT_a:.4f}, avgrank: {rank_a:.4f}, v_loss: {val_loss_a:.4f}")
        print(f"B: NDCG: {NDCG_b:.4f}, HT: {HT_b:.4f}, avgrank: {rank_b:.4f}, v_loss: {val_loss_b:.4f}")
        return (NDCG_m, HT_m, val_loss_m), (NDCG_a, HT_a, val_loss_a), (NDCG_b, HT_b, val_loss_b)
    ...
    def run_test(self, i):
        ...
        return (NDCG_m, HT_m), (NDCG_a, HT_a), (NDCG_b, HT_b)
